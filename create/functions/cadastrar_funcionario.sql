...
BEGIN
	...
	INSERT INTO "Funcionario" (nome, cpf_cnpj, rg, telefone, celular, data_de_admissao, salario, especialidade)
    	VALUES (
			cadastrar_nome, cadastrar_cpf_cnpj, cadastrar_rg, cadastrar_telefone, cadastrar_celular,
			...
			RETURNING pessoa_id INTO cadastrar_funcionario_id;
